...
final class WebRTCClient: NSObject {
    ...
    required init(iceServers: [String]) {
        ...
        // Create ICE server with username and password
        //let iceServer = RTCIceServer(urlStrings: ["turn:your_turn_server.com:3478"], username: "your_username", credential: "your_password")
        
        
        config.iceServers=[RTCIceServer(
            urlStrings: ["stun:101.34.22.225:3478"],
           username: "housekeeper",
            credential:"housekeeper123"
       )]
