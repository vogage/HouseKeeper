...
extension Message: Codable {
    init(from decoder: Decoder) throws {
        ...
        case String(describing: MyData.self):
            self = .mydata(try container.decode(MyData.self, forKey: .payload))
        default:
    ...
    func encode(to encoder: Encoder) throws {
        ...
        case .mydata(let data):
            ...
            try container.encode(String(describing: MyData.self), forKey: .type)
        }
